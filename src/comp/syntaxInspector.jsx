...
export default function SyntaxInspector({
  ...
  return (
    <div className="flex flex-col space-y-2.5 font-mono text-xs overflow-hidden flex-1 min-h-0">
      {/* 1. Lista Jerárquica de Nodos (Aprovecha todo el espacio disponible) */}
              ...
              >
                ...
                <div className="flex items-center justify-between">
                  <button
                    ...
                    title="Activar/desactivar recuadro individual"
                  >
                    <span
...
{/* 2. Anatomía de Clase */}
<div className="p-2.5 bg-slate-900 border border-slate-700/80 rounded-lg space-y-2 text-slate-200 shrink-0">
  ...
  {info ? (
    <div className="space-y-1 text-[11px]">
      {/* Muestra las Variantes/Breakpoints si existen */}
    ...
    <p className="text-[10px] text-slate-500 italic">
      Selecciona una clase arriba para analizar su estructura.
    </p>
  )}
</div>
    </div>
